    ...
    <React.Fragment>
          ...
          <div className='row'>
            ...
            <div className='col-6 contant'>
              <div className='col-10'>
                <h1>Medicine</h1>
                <p>IBM Watson Micromedex Consumer Information (Advanced)
                  IBM Watson Micromedex Advanced Consumer Information provides comprehensive consumer information pertaining to a wide variety of drugs, such as a list of commonly used brand names, drug descriptions, warnings and precautions, and detailed information on the proper use of each drug.</p>
              </div>
              <div className='Btn_style Signup-class'>
                <h3>
                  <button className='link Signup-btn width btn-transparent'><a className='medocone-text' href='#Store'> Store Medicine</a></button>
                </h3>
              </div>
            </div>
          </div>
      ...
      <section id='Store' className='medicine-Store'>
        <center>
          <table border={1}>
            <tr>
              <th className='Boder' colSpan={5}> <h1>Medicine Store List </h1></th>
            </tr>
            <tr>
